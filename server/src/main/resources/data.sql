...
INSERT INTO PRICEREDUCTION (ID_PRICEREDUCTION ,ID_ITEM ,REDUCED_PRICE ,START_DATE ,END_DATE )
VALUES
(1,1,10,CURRENT_DATE(),CURRENT_DATE() +7),
(2,2,20,CURRENT_DATE(),CURRENT_DATE() +7),
(3,2,20,CURRENT_DATE()+8,CURRENT_DATE() +14),
(4,3,30,CURRENT_DATE(),CURRENT_DATE() +7),
(5,4,50,CURRENT_DATE(),CURRENT_DATE() +7)